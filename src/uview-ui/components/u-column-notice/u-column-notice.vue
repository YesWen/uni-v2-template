<template>
    ...
    >
        <view class="u-icon-wrap">
            ...
            <image class="u-m-r-20" style="width: 48rpx; height: 48rpx;" src="/static/image/notice.png" />
        </view>
        <swiper
        ...
        <view @click="getMore" class="u-icon-wrap">
            <!-- <text style="color: #606266;">更多</text> -->
            <u-icon class="u-right-icon" v-if="moreIcon" name="arrow-right" :size="26" :color="computeColor"></u-icon>
